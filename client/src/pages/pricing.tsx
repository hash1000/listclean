       ...
       <nav className="py-3 border-gray-100">
        ...
        <div className="py-20">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            <h1 className="mb-2 p-1 text-5xl font-bold  bg-clip-text bg-gradient-to-br from-emerald to-magnolia">Pricing</h1>
             <p className="text-lg">
              ListClean offers pricing plans for businesses of all sizes. Get started today!</p>
              </div> 
              <div className="isolate mx-auto mt-10 grid max-w-6xl grid-cols-1 justify-items-center gap-6 justify-between lg:grid-cols-4">
                </div>
                </div>
        </div>
      </>
